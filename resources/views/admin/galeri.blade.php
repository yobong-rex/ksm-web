    ...
    <div class="container-fluid m-0 p-0" style="height: 100vh; overflow-y: auto">
        <div class="gallery-wrapper pt-5 container">
            ...
            <div class="text-center p-5">
                <a class="btn btn-primary font-weight-bold mt-3 h1 p-3 pl-5 pr-5 text-white" style="font-size: 20px" onclick="loadMoreGallery()">Muat Lebih Banyak</a>
            </div>
        </div>
    </div>
@endsection
            ...
            $.ajax({
				...
				success: function(data){
                    data.galeri.map((element) => {
                        ...
                        $('#daftar-galeri').append("<div class='col-10 col-sm-10 col-md-5 col-lg-5 col-xl-4 p-0 bg-dark img-gallery'><img class='rounded-0 img-image' src='../assets/img/galeri/" + folderName + "/" + thumbnail + "' alt='event-ksm'><div class='h4 text-white text-image text-center font-weight-bold poppins-normal'>" + element.nama + "</div></div>")
