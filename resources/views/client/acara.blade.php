    ...
    <section>
            <div class="container" id="acara">
                ...
                <div class="row ">
                    ...
                    <img class="d-block w-100" src="{{ asset('assets/img/poster_acara/'.$acara[0]->link_gambar.'') }}" alt="First slide">
                    </div>
                    ...
                    <p>{{$acara[0]->tanggal_mulai}}</p>

                    </div>
                    <div class="col-md-12 col-lg-12 col-xl-6 text-center" style="padding:20px 0px">
                    <p class="card-text h4 event-text"><b>Close Registraion</b></p>
                    <p>{{$acara[0]->tanggal_akhir}}</p>

                    </div>
                </div>     
                
                <div class="text-center"><p class="card-text h4 event-text" style="padding:20px 0px"><b>Contact Person (WA) :</b> <a href="https://wa.me/{{$acara[0]->nomer_cp}}">{{$acara[0]->nomer_cp}} ({{$acara[0]->nama_cp}})</a></p>

                @if($status == true)
                <a href="/pendaftaran/@php echo str_replace(' ', '-', strtolower($acara[0]->nama)).'-'.$acara[0]->tahun; @endphp" class="btn btn-primary font-weight-bold btn-daftar text-center ml-4 mb-3" style="margin: 20px 0px ">Daftar</a>
                @else
                <button class="btn btn-primary font-weight-bold btn-daftar text-center ml-4 mb-3" style="margin: 20px 0px " disabled>Tutup</button>
                @endif
</div>
            </div>
                                        </div>
